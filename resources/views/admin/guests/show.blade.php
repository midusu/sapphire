    ...
    <div class="bg-white rounded-lg shadow p-6 mb-6">
        <div class="flex justify-between items-start">
            ...
            <div class="flex space-x-2">
                <a href="{{ route('admin.bookings.create') }}?guest_id={{ $guest->id }}" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition">
                    <i class="fas fa-plus mr-2"></i>New Booking
                </a>
                <a href="{{ route('admin.guests.edit', $guest) }}" class="bg-yellow-600 text-white px-4 py-2 rounded-lg hover:bg-yellow-700 transition">
            ...
            <div class="space-y-3">
                ...
                @if($guest->date_of_birth)
                    <div>
                        ...
                        <p class="font-medium">{{ $guest->date_of_birth->format('M d, Y') }} ({{ $guest->date_of_birth->age }} years)</p>
                    </div>
                @endif
                @if($guest->gender)
                    <div>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden mt-6">
        ...
        @if($guest->bookings->count() > 10)
            <div class="px-6 py-3 border-t">
                <a href="{{ route('admin.bookings.index') }}?guest_id={{ $guest->id }}" class="text-blue-600 hover:text-blue-800 text-sm">
                    View all bookings →
                </a>
            </div>
        @endif
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($guest->activityBookings->take(5) as $activityBooking)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('admin.activities.bookings.show', $activityBooking) }}" class="text-blue-600 hover:text-blue-900">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
